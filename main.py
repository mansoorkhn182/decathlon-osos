...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://miuuyruyjpfwdn:e002c2275ae8e0907aec09017b8c5f6bae7fac14295c9c5f0102c20b1f7ab0b0@ec2-54-216-17-9.eu-west-1.compute.amazonaws.com:5432/dc9l5uuo40ik70'
db = SQLAlchemy(app)
...
def procdata():
    ...
    json_file_name = 'static/files/'+username+'-'+filename.split('.csv')[0]+'.json'
