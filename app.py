...
def procdata():
    ...
    file_path = os.path.join("static/files", filename)##'/app/static/files/'+filename
    ...
    json_file_name = os.path.join("static/files", username+'-'+filename.split('.csv')[0]+'.json')##'/app/static/files/'+username+'-'+filename.split('.csv')[0]+'.json'
